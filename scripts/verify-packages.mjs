...
const steps = [
  ...
  ["integrations typecheck", "npm", ["run", "typecheck", "--prefix", resolve(rootDir, "packages/integrations")]],
  ["integrations build", "npm", ["run", "build", "--prefix", resolve(rootDir, "packages/integrations")]],
  ["integrations tests", "npm", ["test", "--prefix", resolve(rootDir, "packages/integrations")]],
